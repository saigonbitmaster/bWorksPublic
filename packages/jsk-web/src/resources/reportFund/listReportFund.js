...
class ListReportFund extends Component {
  render() {
    const { translate, ...rest } = this.props;
   
    return (
      <List {...rest} filters={<Filters />} resource="jsreportfunds"  title={walletAddress} hasCreate={true}  bulkActionButtons={false}>
        <Datagrid >
...
export default compose(translate)(ListReportFund);
