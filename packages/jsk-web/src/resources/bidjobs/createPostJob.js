...
import { Create, FlexForm, TextInput, required, translate, SelectInput, EditorInput, DateTimeInput, NumberInput,BooleanInput } from 'ra-loopback3';
    ...
    return (
      <Create {...props} resource="postjobs">
        ...
        <Grid middle container spacing={2}>
            ...
            <Grid middle item xs={12} sm={6}>
              <TextInput source="employer"  label="Employer name/wallet address"/>
            </Grid>
            <Grid middle item xs={12} sm={6}>
              <NumberInput source="bidValue" label="Bid value" />
            </Grid>
            <Grid middle item xs={12} sm={6}>
            ...
            <Grid middle item xs={12} sm={6}>
              <DateTimeInput source="expectedDate"  label="Bid date"/>
            </Grid>
