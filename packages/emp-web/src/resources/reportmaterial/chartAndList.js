...
class ChartAndList extends Component {
  ...
  handlePrint = () => {
    const { sumTotalMeter, sumTotalSensor, sumTotalDataLogger, sumTotalPump, data, sourceList, filter } = this.state;
    ...
    templateData.sumData01 = translate('resources.reportmaterials.sumTotalMeter', {
      val: format.number(sumTotalMeter, 0),
    });
...
*/
  ...
  render() {
    ...
    const { sumTotalMeter, sumTotalSensor, sumTotalDataLogger, sumTotalPump, sum, filter } = this.state;
    // let optionFormat;
    // let subTitle = [
    //   {
    //     id: 1,
    //     content: translate('resources.reportmaterials.sumTotalMeter', { val: format.number(sumTotalMeter, 0) }),
    //   },
    //   {
    //     id: 2,
