...
const barchart1 = [
  {
    ...
    'job posts': 4000,
    'job bids': 8000,
    'smart contracted jobs': 4000,
    'completed smart  contracts': 2000,
  },
  {
    name: 'Feb',
    'job posts': 4500,
    'job bids': 9000,
    'smart contracted jobs': 4000,
    'completed smart  contracts': 3000,
  },
  {
    name: 'March',
    'job posts': 6000,
    'job bids': 9000,
    'smart contracted jobs': 5000,
    'completed smart  contracts': 3500,
  },
  {
    name: 'April',
    'job posts': 8000,
    'job bids': 13000,
    'smart contracted jobs': 7000,
    'completed smart  contracts': 4500,
  },
  {
    'job posts': 9000,
    'job bids': 14000,
    'smart contracted jobs': 7000,
    'completed smart  contracts': 6500,
  },
  {
    name: 'June',
    'job posts': 9000,
  ...
  },
  {
    ...
    'job posts': 11000,
    'job bids': 16000,
    'smart contracted jobs': 8000,
    'completed smart  contracts': 7500,
  },
];
...
const data02 = [
  {
    "name": "Submitting smart contracts",
    "value": 2400
  },
  {
    "name": "Succeed smart contracts",
    "value": 4567
  },
  {
    "name": "Failed smart contracts",
    "value": 1398
  },
  {
    "name": "Pending smart contracts",
    "value": 9800
  }
];
        ...
        <Grid middle container spacing={4} direction="row" justifyContent="center" alignItems="center" >
          <Grid middle item xs={12} sm={6} >
            <BarChart width={730} height={320} data={barchart1}>
              ...
              <Bar dataKey="smart contracted jobs" fill="#82ca9d" />
              <Bar dataKey="completed smart  contracts" fill="#82ca9d" />
            </BarChart>
          </Grid>

          <Grid middle item xs={12} sm={6}>
            <BarChart width={730} height={320} data={barchart2}>
              <CartesianGrid strokeDasharray="3 3" />
              <XAxis dataKey="name" />
              <YAxis />
              <Tooltip />
