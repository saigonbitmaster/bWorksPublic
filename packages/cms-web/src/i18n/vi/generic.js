...
export default {
  ...
  widgets: {
    ...
    someQuantity: 'Sản lượng (m³)',
    totalSourceQuantity: 'Sản lượng',
    someLoss: 'Thất thoát (m³)',
  ...
  pages: {
    ...
    someLoss: 'Sản lượng/Thất thoát',
    someFlowPressure: 'Lưu lượng/Áp lực',
    ...
    somesourcegroup: 'Nhóm nguồn',
    somesource: 'Nguồn nước',
    pump: 'Máy bơm',
    sensor: 'Cảm biến',
    meter: 'Đồng hồ',
    datalogger: 'Thiết bị ghi/phát',
    someStandard: 'Chất lượng nước',
    someParameter: 'Thông số đo',
